...
export const searchMessagesTool: Tool = {
  ...
  description: "Semantic search over retained short-term messages. Use for exact transcript evidence; it is not graph-ranked broad recall.",
  inputSchema: {
    type: "object",
    properties: {
      query: {
      ...
      channel: {
        type: "string",
        description: "Filter by exact channel or peer scope.",
      },
      sessionKey: {
        type: "string",
