...
crons.interval("stm-retry-retirement", { hours: 1 }, internal.crystal.messages.retryStuckRetirements, {});
...
crons.interval(
  ...
  { hours: 1 },
  internal.crystal.organic.recallCompressionBackfill.runRecallCompressionBackfill,
  {},
);
