...
) : Promise<{ knowledgeBase: KnowledgeBaseDoc; memories: Array<any>; graphContext?: any; degradation?: Record<string, any> } | { knowledgeBase: KnowledgeBaseDoc; memories: []; graphContext?: any; degradation?: Record<string, any> }> => {
  const knowledgeBase = await ctx.runQuery(
    internal.crystal.knowledgeBases.getKnowledgeBaseByIdInternal,
    { knowledgeBaseId: args.knowledgeBaseId }
  ) as KnowledgeBaseDoc | null;
