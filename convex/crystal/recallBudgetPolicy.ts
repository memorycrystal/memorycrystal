...
/**
 * Convex Cloud search-query billing is the reason this breaker exists. A
 * self-hosted deployment can explicitly disable the synchronous ledger writes
 * while keeping the safer Cloud default.
 */
