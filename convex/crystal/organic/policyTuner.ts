...
const pickWeights = (doc: Partial<RecallPolicyWeights>): RecallPolicyWeights => ({
  ...
  sourceRoleWeight: doc.sourceRoleWeight ?? defaultRecallRankingWeights.sourceRoleWeight,
  projectWeight: doc.projectWeight ?? defaultRecallRankingWeights.projectWeight,
  personalWeight: doc.personalWeight ?? defaultRecallRankingWeights.personalWeight,
});
