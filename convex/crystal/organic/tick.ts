...
function openRouterCostAttribution(apiKeyOverride?: string | null): { keySource: CostKeySource; payer: CostPayer } {
  if (apiKeyOverride) return { keySource: "user_byok", payer: "user" };
  if (process.env.OPENROUTER_API_KEY) return { keySource: "platform", payer: "company" };
...
export const processUserTick: any = internalAction({
  ...
  handler: async (ctx, args): Promise<any> => {
    ...
    try {
      ...
      const organicCostAttribution = openRouterCostAttribution(openrouterApiKey);
