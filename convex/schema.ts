...
export default defineSchema({
  ...
  // One row per calendar day (UTC). Used to enforce a configurable daily
  // Gemini call cap (env: GEMINI_DAILY_CALL_CAP). Off by default.
  crystalGeminiDailyUsage: defineTable({
    dateKey: v.string(),        // "YYYY-MM-DD" UTC
    callCount: v.number(),      // total Gemini API calls today
