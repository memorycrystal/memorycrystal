...
# Wave-1 recall-quality defaults (see plan table A): surface 10 memories with
# ~750-char previews inside an ~11k-char context budget, give automatic recall
# an 8s budget, and require 5 consecutive hard failures to open the breaker.
MAX_MEMORIES = 10
MAX_CONTEXT_CHARS = 11000
MEMORY_PREVIEW_CHARS = 750
DEFAULT_TIMEOUT = 8.0
    ...
    def request(self, path: str, payload: dict[str, Any] | None = None, method: str = "POST", timeout: float | None = None) -> dict[str, Any]:
        ...
        request = urllib.request.Request(
            ...
            headers={
                ...
                "User-Agent": "memory-crystal-hermes-plugin/0.8.17",
            },
        )
        try:
