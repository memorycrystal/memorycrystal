...
# budget, give automatic recall an 8s budget, and require 5 consecutive hard
# failures to open the breaker.
MAX_MEMORIES = 12
MAX_CONTEXT_CHARS = 12500
MEMORY_PREVIEW_CHARS = 800
DEFAULT_TIMEOUT = 8.0
DEFAULT_RECALL_TIMEOUT = 10.0
DEFAULT_AUTO_RECALL_TIMEOUT = 8.0
...
def _recall_context(session_id: str, query: str, platform: str | None = None, *, is_first_turn: bool = False, **kwargs: Any) -> str:
    ...
    try:
        ...
        recall = client.recall(text, session_id, channel, limit=_max_memories(), automatic=True, **_memory_scope(kwargs))
