    ...
    def request(self, path: str, payload: dict[str, Any] | None = None, method: str = "POST", timeout: float | None = None) -> dict[str, Any]:
        ...
        request = urllib.request.Request(
            ...
            headers={
                ...
                "User-Agent": "memory-crystal-hermes-plugin/0.8.5",
            },
        )
        try:
...
class MemoryCrystalProvider:
    ...
    def get_config_schema(self) -> dict[str, Any]:
        return {
            "api_key": {"type": "string", "secret": True, "env": "MEMORY_CRYSTAL_API_KEY"},
            "api_url": {"type": "string", "default": DEFAULT_API_URL, "env": "MEMORY_CRYSTAL_API_URL"},
            "mode": {"type": "string", "enum": ["auto", "provider", "hooks", "disabled"], "default": "auto"},
            "capture_turns": {"type": "boolean", "default": True},
            "inject_recall": {"type": "boolean", "default": True},
            "allow_group_writes": {"type": "boolean", "default": False},
        }
