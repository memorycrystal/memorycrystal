...
Factory Droid is a Tools-tier generic MCP host, not an official platform. It stays installable via `--targets factory-droid` or `--targets generic-mcp`. See [Support Tiers](/concepts/support-tiers).
...
- treating Factory Droid as an official platform or as Full tier
