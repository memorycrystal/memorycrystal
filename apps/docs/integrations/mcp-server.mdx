...
### Use the deprecated stdio/SSE package for:
- Claude Desktop
...
The deprecated package (`mcp-server`) exposes the older stdio/SSE form of the same memory tool surface.
