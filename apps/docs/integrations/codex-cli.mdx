---
> **Default change (ILL-281):** Automatic recall injection is now off by default on all hosts. Set `MEMORY_CRYSTAL_INJECT_RECALL=true` in your environment to restore automatic pre-response recall.
