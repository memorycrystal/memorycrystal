...
> Current release: **v0.7.9**. See the [changelog](/changelog) for what shipped, and use the [uninstall guide](/help/uninstall) when you need a clean rollback.
...
- `mcp-server/` — deprecated stdio/SSE MCP server
