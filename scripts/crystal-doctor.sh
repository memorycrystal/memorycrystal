...
if isinstance(allow, list) and "crystal_status" in allow:
    ok("plugins.allow includes crystal_status")
elif isinstance(allow, list) and len(allow) > 0:
    warn("plugins.allow does not include crystal_status; openclaw crystal_status will be blocked")
if isinstance(allow, list) and "crystal_doctor" in allow:
    ok("plugins.allow includes crystal_doctor")
elif isinstance(allow, list) and len(allow) > 0:
    warn("plugins.allow does not include crystal_doctor; openclaw crystal_doctor will be blocked")
