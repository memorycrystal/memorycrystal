...
class FakeClient:
    ...
    def wake(self, session_id, channel, automatic=False): return {"briefing": "ready"}
    def recall(self, query, session_id, channel, limit=6, automatic=False): return {"memories": [{"title": "contract", "content": "provider fixture"}]}
