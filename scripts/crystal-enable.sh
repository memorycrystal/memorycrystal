...
REQUIRED_ENV_KEYS=(CONVEX_URL CRYSTAL_CONVEX_URL CRYSTAL_CONVEX_SITE_URL MEMORY_CRYSTAL_API_URL OPENAI_API_KEY MEMORY_CRYSTAL_API_KEY GEMINI_API_KEY GEMINI_EMBEDDING_MODEL EMBEDDING_PROVIDER OBSIDIAN_VAULT_PATH CRYSTAL_BACKEND CRYSTAL_LOCAL_LLM_STUB CRYSTAL_EMAIL_DRY_RUN CRYSTAL_MCP_MODE CRYSTAL_MCP_HOST CRYSTAL_MCP_PORT)
