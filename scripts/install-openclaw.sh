...
if (!cfg.plugins.allow.includes('crystal_status')) cfg.plugins.allow.push('crystal_status');
if (!cfg.plugins.allow.includes('crystal_doctor')) cfg.plugins.allow.push('crystal_doctor');
