...
test("constants are 1600 KB / 800 non-KB", () => {
  assert(KB_MAX_CHARS === 1600, `expected 1600, got ${KB_MAX_CHARS}`);
  assert(NON_KB_MAX_CHARS === 800, `expected 800, got ${NON_KB_MAX_CHARS}`);
});
