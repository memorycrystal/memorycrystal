...
describe("crystal-memory plugin — Phase 2 integration", () => {
  ...
  test("3a. reduced mode assemble skips startup-style remote recall injection", async () => {
    ...
    assert.equal(fetchCalls.some((call) => call.url.endsWith("/api/mcp/recall")), false, "reduced mode assemble should not hit remote recall");
  });
