...
// once the conversation itself grows past the remaining capacity. 11k chars
// (~2.75k tokens) fits up to 10 recalled memories at the larger content caps +
// recent messages + skills while still leaving the vast majority of the window
// for the actual conversation.
const INJECTION_CEILING_CHARS = 11_000;
...
// while accommodating the larger recall window (up to 10 memories).
